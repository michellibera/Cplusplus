/* 1. dane s¹ 2 wektory a(n)  i b (n)  z wyk f s³u¿¹cych do wczytywania elemantów
 z klawiatury wypisywania alementów wektorów na ekran  iloczyn skalarny 2 wektorow obliczyc wartosc wyrazenia (ai^2 + bi^2)/aibi*/
...
float wyrazenie;
    ...
    cout<<iloczynaa(n)<<endl;
    cout<<iloczynbb(n)<<endl;
